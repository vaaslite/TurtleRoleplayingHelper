...
function RPListFrame_OnShow()
	...
	getglobal(this:GetName().."CheckButtonANY"):SetChecked( PlaceInArray( RPCONFIG.traits, "GOBLIN" ) )
	getglobal(this:GetName().."CheckButtonANY"):SetChecked( PlaceInArray( RPCONFIG.traits, "HIGHELF" ) )
...
function RPListUpdate()
	...
	if PlaceInArray( RPCONFIG.traits, command ) then
		...
		elseif	( command == "HIGHELF" ) then
			dcf( "You're no longer roleplaying like a high elf." )
		elseif	( command == "ORC" ) then
			dcf( "You're no longer roleplaying like an orc." )
		elseif	( command == "UNDEAD" ) then
			dcf( "You're no longer roleplaying like an undead." )
		else
		...
		elseif	( command == "HIGHELF" ) then
			dcf( "You're now roleplaying like a high elf." )
		elseif	( command == "ORC" ) then
			dcf( "You're now roleplaying like an orc." )
		elseif	( command == "UNDEAD" ) then
			dcf( "You're now roleplaying like an undead." )
		else
