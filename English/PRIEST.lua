...
--=====================================================================--
RPWORDLIST.entercombat.PRIEST = {"I see death in your near future.",
...
--=====================================================================--
RPWORDLIST.leavecombat.PRIEST = {"This trip to the next world brought to you by PLAYER_GUILDNAME.",
...
-- by default your health must be above 70%
--=====================================================================--
RPWORDLIST.block.PRIEST = {"I can't block attacks, you idiot! Move along..."}
...
RPWORDLIST.youcritspell.PRIEST.random = {"I have been chosen... by the big metal hand in the sky!",
}
--=====================================================================--
...
RPWORDLIST.youcritheal.PRIEST.random = {"I have been chosen... by the big metal hand in the sky!",
"Wait, you got insurance, right?",
"Call my clothes a dress one more time...!",}
