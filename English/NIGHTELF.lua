...
--=====================================================================--
RPWORDLIST.entercombat.NIGHTELF = {"For Cenarius!",
...
-- by default your health must be above 70%
--=====================================================================--
RPWORDLIST.miss.NIGHTELF = {"The stars align.",}
...
-------------------------------------------------------------------------
RPWORDLIST.talktonpc_beginning.NIGHTELF = {"Well met.",
...
-------------------------------------------------------------------------
RPWORDLIST.talktonpc_middle.NIGHTELF = {"The quel'dorei may be part of us now, but I do not trust their ways.",
"The Sun will always envy the stars.",
"... and I told him: 'Come, friend or betrayer, come look upon the heart.'",
"The Highborne led to the destruction of this world; the quel'dorei are doomed to the same fate.",
"The orcs have invaded our forests with impunity for too long.",
"The tauren are peaceful creatures. That, I respect.",
"Illidan's actions won't be forgotten.",
"Hjal... Ah...",
"Our lands are victim to a spreading corruption. We must find its source.",
"We have suffered far more than any other race.",}
...
-- The END of a conversation with an NPC
	-- "CURTSEY" is automatically added for female characters
-------------------------------------------------------------------------
RPWORDLIST.talktonpc_end.NIGHTELF = {"Until next we meet.",
"TARGET, safe travels.",
"Farewell.",
"TARGET, go in peace.",
...
--=====================================================================--
RPWORDLIST.resurrect.NIGHTELF = {"For a brief moment, I felt the presence of Elune.",
"For a moment, I felt the presence of Elune.",
"Praised be the Goddess!",
"I have lived for thousands of years. This could not be the end."}
...
--  Trade Window Opens
--=====================================================================--
RPWORDLIST.trade_show.NIGHTELF = {"Well met, TARGET.",
"Elune be with you, TARGET.",
"Goddess bless you.",
"Ish'nu Al'ah, TARGET.",
"TARGET, I am honored.",
...
--  Trade Window Closes
--=====================================================================--
RPWORDLIST.trade_closed.NIGHTELF = {"TARGET, till next we meet.",
"TARGET, safe travels.",
"Farewell, TARGET.",
"TARGET, go in peace.",
