...
--=====================================================================--
RPWORDLIST.entercombat.HUNTER = {"The beast with me is nothing compared to the beast within...",}
...
--=====================================================================--
RPWORDLIST.youcrit.HUNTER = {"I will feed your corpse to the beasts of the wild.",
"Anyone ordered a lead salad?",
"Bull's eye!",}
...
--=====================================================================--
RPWORDLIST.petattackstop.HUNTER = {"What's that smell?  Bad PNAME, bad!",}
...
-- When your PET DIES.
	-- PNAME = Pet's Name
--=====================================================================--
RPWORDLIST.petdies.HUNTER = {"PNAME! Play dead!",
...
--=====================================================================--
RPWORDLIST.resurrect.HUNTER = {"Oh that feels g- Wait...? Who touched my ammo pouch?",
}
...
-- Marksmanship
--=====================================================================--                                     
RPWORDLIST.arcane_shot.HUNTER = {"This one has a little more... impact!"}
RPWORDLIST.arcane_shot.HUNTER.emote = {}
RPWORDLIST.arcane_shot.HUNTER.customemote = {"adds some arcane power to this shot for a little more oomph.",
...
RPWORDLIST.concussive_shot.HUNTER = {"Not so fast!",
...
RPWORDLIST.flare.HUNTER = {"Come to me openly, and not by stealth.",
"Lights on!",
"Let's bring some light!",
"I like the sound these make.",
"I should get these in blue."}
...
RPWORDLIST.immolation_trap.HUNTER = {"Ooops, I dropped something."}
...
"Uuuuuh, I dieeee-eeeh...",
"Don't move, don't move...",
"I'm one with the ground, the ground is one with me...",
"I... die...!",
"Ugh-Ah!",
"M-my last... breath..."}
