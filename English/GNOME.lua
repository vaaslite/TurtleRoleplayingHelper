...
--=====================================================================--
RPWORDLIST.entercombat.GNOME = {"For Gnomeregan!",
"Charge!",
...
--=====================================================================--
RPWORDLIST.hurt.GNOME = {"Not in the face! Not in the face!",
...
"Ah! You scared the soul out of me!",}
...
--=====================================================================--
RPWORDLIST.youcrit.GNOME = {"Take that!",
...
"Who's short now? Looks like you are short on fuel to supply your locomotive functions!"}
...
--=====================================================================--
RPWORDLIST.youcritspell.GNOME = {"Take that!",
"Take that, and that, and this one too!",
...
"Look out! Too late.",
"Combat is much more fun when I'm winning!",
"No, I'm not Ricky Dicky doo-dah Grimes!"}
...
-------------------------------------------------------------------------
RPWORDLIST.talktonpc_middle.GNOME = {"One day, I dream of retaking Gnomeregan- and a toilet that does the water squirting thingie- I mean, Gnomeregaaaan!",
"I love cogs, magnifying glasses and... Stormwind Brie! So smooth!"}
RPWORDLIST.talktonpc_middle.GNOME.emote = {}
...
-- The END of a conversation with an NPC 
	-- "CURTSEY" is automatically added for female characters
-------------------------------------------------------------------------
RPWORDLIST.talktonpc_end.GNOME = {"TARGET, till next we meet.",
...
--=====================================================================--
RPWORDLIST.resurrect.GNOME = {"Last time you may have defeated me. However, I am not the same gnome you met before. This time I reached a level beyond any average gnome. You could say, I became super."}
...
--  Trade Window Opens
--=====================================================================--
RPWORDLIST.trade_show.GNOME = {"TARGET, what did you have in mind?",
"TARGET, wait, wait, I got a cog or two here.",
"TARGET, do you have my recombulator?",
"Hello, tall one.",
"'Cheesed to meet you'. Hehe, did you get it?"}
RPWORDLIST.trade_show.GNOME.emote = {"GREET"}
...
--  Trade Window Closes
--=====================================================================--
RPWORDLIST.trade_closed.GNOME = {"TARGET, don't blow anything up!.",
"TARGET, you won't regret this.",
"TARGET, see you!",
"Be seeing you!",}
RPWORDLIST.trade_closed.GNOME.emote = {"THANK"}
